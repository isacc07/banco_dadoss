...
genero varchar(50),
ano_lancamento int,
tipo varchar(10) check (tipo in ('Filme', 'Serie'))
);
...
select * from midias where genero like '%Ficção Científica%' and tipo like 'Filme';

select * from midias where tipo = 'Serie' and genero like  'Crime, Drama';
#Peaky Blinders, The sopranos e Better Call Saul.
