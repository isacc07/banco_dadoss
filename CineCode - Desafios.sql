...
-- ALUNO: Isac Pereira Pego De Souza_________________________________________________________________
-- DATA: 20/08/2026
--
-- INSTRUÇÕES:
...
-- 5. Liste todos os clientes que moram no estado de 'São Paulo'.
	...
	select * from clientes where estado = 'Sao Paulo';
...
-- 9. Precisamos listar os filmes de 'Mistério e Suspense' OU 'Ficção e Fantasia'.
	...
	select * from filmes where genero = 'Misterio e suspense' or genero = 'Ficçao e Fantasia';
...
-- Qual é o erro? Faltou o sinal de igual.____________________________________________________
-- Correção: 
	SELECT titulo, genero, ano_lancamento FROM filmes WHERE ano_lancamento = 2005  ORDER BY titulo;
...
-- Qual é o erro?	Estava Escrito estado e nao regiao. _______________________________________________________
-- Correção:
...
-- Qual é o erro?  Era 'is null'.________________________________________________________
-- Correção:
...
-- Qual é o erro? Faltou colocar atores no lugar de "actor".__________________________________________________________
-- Correção: SELECT nome_ator, nacionalidade FROM actor;
...
-- Qual é o erro? Ele listou todos os filmes no lugar de apenas um. __________________________________________________________
-- Correção
UPDATE filmes
SET genero = 'Fantasia'
